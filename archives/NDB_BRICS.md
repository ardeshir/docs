...
1. Circulate alongside national currencies for international transactions
1. Create an Issuing Bank with predetermined rules
1. Back the currency with BRICS-guaranteed bonds (not gold or commodities, given price volatility)
1. Use the CRA and NDB as circulation mechanisms
...
**Scenario B: Financial Fragmentation**
